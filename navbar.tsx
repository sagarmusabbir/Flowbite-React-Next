...
const MegaMenuHeader: FC = function () {
  return (
    <header>
      ...
      <MegaMenu className="border-y py-0 border-gray-200 dark:border-gray-600 max-w-full">
        ...
        <MegaMenu.Collapse>
          <div className="-mx-4 grid py-4 px-4 text-gray-900 dark:text-white md:grid-cols-2 lg:grid-cols-4 md:px-6 dark:border-gray-600 max-w-full">
