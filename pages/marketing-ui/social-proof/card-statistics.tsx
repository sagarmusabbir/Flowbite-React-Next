    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6 xl:px-0">
        ...
        <div className="mb-4 space-y-4 md:mb-8 md:grid md:grid-cols-3 md:gap-4 md:space-y-0 xl:gap-16">
          <Card className="flex items-center justify-center rounded border-0 bg-gray-100 text-center shadow-none p-0 xl:p-6">
            <div>
              <p className="mb-2 text-4xl font-extrabold md:text-5xl dark:text-white">40%</p>
              <h3 className="mb-2 text-xl font-semibold dark:text-white">Reduction</h3>
          ...
          <Card className="flex items-center justify-center rounded border-0 bg-gray-100 text-center shadow-none p-0 xl:p-6">
            <div>
              <p className="mb-2 text-4xl font-extrabold md:text-5xl dark:text-white">469%</p>
          ...
          <Card className="flex items-center justify-center rounded border-0 bg-gray-100 text-center shadow-none p-0 xl:p-6">
            <div>
              <p className="mb-2 text-4xl font-extrabold md:text-5xl dark:text-white">60+</p>
              <h3 className="mb-2 text-xl font-semibold dark:text-white">Minutes saved</h3>
              <p className="text-gray-500 dark:text-gray-400">
