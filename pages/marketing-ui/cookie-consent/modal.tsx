...
const CookieConsentModal: FC = function () {
  ...
  return (
    <>
      ...
      >
        <Modal.Header className="[&>h3]:w-full [&>h3]:flex [&>h3]:justify-between [&>button]:hidden dark:border-gray-700">
          <a
            href="#"
          ...
          <div className="items-center justify-between space-y-4 pt-0 sm:flex sm:space-y-0">
            <div className="items-center space-y-4 sm:flex sm:space-x-4 sm:space-y-0">
              ...
              <Button
                ...
                onClick={() => setShow(false)}
                outline
                className="inline-flex w-full sm:w-fit [&>span]:px-5 [&>span]:py-3 hover:[&>span]:!text-gray-900 dark:hover:[&>span]:!text-white dark:[&>span]:!bg-gray-700  dark:hover:[&>span]:!bg-gray-600"
              >
                Block cookies
              </Button>
            </div>
