...
const PopupEmailSignUpNewsletterSection: FC = function () {
  ...
  return (
    <div className="flex justify-center">
      ...
      <Modal onClose={() => setShow(false)} position="bottom-right" show={show} size="md" theme={{content: {inner: "relative rounded-lg bg-white shadow dark:bg-gray-800 flex flex-col max-h-[90vh]"}}}>
        <button
          type="button"
