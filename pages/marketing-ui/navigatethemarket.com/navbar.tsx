...
const MegaMenuHeader: FC = function () {
  return (
    <header>
      ...
      <MegaMenu className="border-y py-0 border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        ...
        <MegaMenu.Collapse>
          <div className="border-t -mx-4 grid py-4 px-4 text-gray-900 dark:text-white dark:bg-gray-800 md:grid-cols-2 lg:grid-cols-4 md:px-6 dark:border-gray-600">
