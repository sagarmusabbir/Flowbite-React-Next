        ...
        <div className="flex items-center justify-center px-4 py-6 sm:px-0 lg:py-0">
          ...
          >
            ...
            <div className="items-center space-x-0 space-y-3 sm:flex sm:space-x-4 sm:space-y-0">
              <Button color="gray" href="#" className="w-full md:w-1/2 hover:bg-gray-50 dark:hover:bg-gray-700">
                <svg
                  aria-hidden
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <Label htmlFor="remember-description" className="text-gray-500 dark:text-gray-300">Remember me</Label>
                </div>
              </div>
              <a
                href="#"
