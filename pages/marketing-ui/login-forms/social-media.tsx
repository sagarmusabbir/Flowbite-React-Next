...
const SocialMediaLoginForm: FC = function () {
  return (
        ...
        <div className="col-span-6 mx-auto w-full rounded-lg bg-white shadow dark:bg-gray-800 sm:max-w-lg md:mt-0 xl:p-0">
          <Card className="shadow-none">
            ...
            <div className="items-center space-y-3 sm:flex sm:space-x-4 sm:space-y-0">
              <Button color="gray" href="#" className="md:w-1/2 hover:bg-gray-50 dark:hover:bg-gray-700">
                <svg
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <Label htmlFor="remember-social" className="text-gray-500 dark:text-gray-300">Remember me</Label>
                  </div>
                </div>
                <a
                  href="#"
