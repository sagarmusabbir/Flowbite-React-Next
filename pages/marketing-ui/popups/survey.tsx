...
const SurveyPopup: FC = function () {
  const [show, setShow] = useState(false);

  return (
    <>
      <Button onClick={() => setShow(true)}>Preview survey popup</Button>
      <Modal onClose={() => setShow(false)} popup show={show} size="xl" theme={{content: {inner: "relative rounded-lg bg-white shadow dark:bg-gray-800 flex flex-col max-h-[90vh]"}}}>
        <Modal.Header />
        <Modal.Body>
