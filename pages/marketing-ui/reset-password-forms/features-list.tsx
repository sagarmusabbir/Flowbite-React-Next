...
const ResetPasswordFormWithFeaturesList: FC = function () {
  return (
          ...
          <form className="mt-4 space-y-4 lg:mt-5 lg:space-y-5">
            ...
            <div className="flex items-start">
              <div className="flex h-5 items-center">
                <Checkbox aria-describedby="terms-features" id="terms-features" required />
              </div>
              <div className="ml-3 text-sm">
                <Label htmlFor="terms-features" className="text-gray-500 dark:text-gray-300">
...
export default ResetPasswordFormWithFeaturesList;
