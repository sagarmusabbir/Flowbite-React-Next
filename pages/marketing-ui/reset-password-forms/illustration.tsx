...
const ResetPasswordFormWithIllustration: FC = function () {
  return (
            ...
            <form className="mt-4 space-y-4 md:space-y-5 lg:mt-5">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <Label htmlFor="terms-illustration" className="text-gray-500 dark:text-gray-300">
...
export default ResetPasswordFormWithIllustration;
