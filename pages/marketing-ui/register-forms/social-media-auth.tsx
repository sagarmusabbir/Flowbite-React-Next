...
const SocialMediaAuthenticationRegisterForm: FC = function () {
  return (
        ...
        <div className="mx-auto w-full rounded-lg bg-white shadow dark:bg-gray-800 sm:max-w-lg md:mt-0 lg:col-span-7 xl:col-span-6 xl:p-0">
          <div className="space-y-4 p-6 sm:p-8 lg:space-y-6">
            ...
            <form className="space-y-4 lg:space-y-6" action="#">
              ...
              <div className="grid grid-cols-1 gap-2">
                <Label htmlFor="countries" className="dark:text-white">Country</Label>
                <Select id="countries">
              ...
              <div className="flex items-start">
                <div className="flex h-5 items-center">
                  <Checkbox aria-describedby="terms-social" id="terms-social" required />
                </div>
...
export default SocialMediaAuthenticationRegisterForm;
