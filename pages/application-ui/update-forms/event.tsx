...
const UpdateEventForm: FC = function () {
          ...
          <div className="gap-4 sm:grid sm:grid-cols-2 xl:grid-cols-3 sm:gap-6 sm:mb-2">
                ...
                <div className="flex items-center mb-1">
                  ...
                  <div className="ml-1 flex">
                    <Tooltip content="Video call options">
                      <button className="text-gray-500 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white dark:text-gray-400">
                        <svg
                          aria-hidden="true"
                          className="w-5 h-5"
                          fill="currentColor"
            ...
            <div className="mb-4 space-y-4">
              ...
              <div className="items-center md:flex md:space-x-4">
                <Avatar.Group className="flex-shrink-0 flex mb-4 md:mb-0 [&_img]:h-8 [&_img]:w-8 dark:[&_img]:ring-gray-800">
                  <Avatar
                    alt="Helene Engels"
                ...
                <Button
                  color="gray"
                  outline
                  className="ml-3 md:ml-0 inline-flex [&>span]:text-xs [&>span]:text-gray-900 [&>span]:bg-white [&>span]:border-gray-200 focus:outline-none hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:[&>span]:bg-gray-800 dark:[&>span]:text-gray-400 dark:[&>span]:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                >
                  <svg
                    aria-hidden
                    className="mr-1 -ml-1 w-4 h-4"
