...
const AdvancedUpdateUserForm: FC = function () {
  return (
          ...
          <div className="grid gap-4 mb-4 md:gap-6 md:grid-cols-2 sm:mb-8">
            <div className="sm:col-span-2">
              ...
              <div className="items-center w-full sm:flex">
                <Avatar
                  ...
                  rounded
                  size="lg"
                  className="justify-start [&_img]:max-w-none mb-4 sm:mr-4 sm:mb-0 sm:justify-center"
                />
            ...
            <div>
              ...
              >
                ...
                <Tooltip
                  ...
                  theme={{
                    base: "absolute inline-block z-10 rounded-lg py-2 px-3 text-xs max-w-xs font-medium shadow-sm",
                  }}
                >
            ...
            <div className="sm:col-span-2">
              ...
              <div className="w-full bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                ...
                <div className="py-2 px-4 bg-gray-50 rounded-b-lg dark:bg-gray-800 dark:[&>textarea]:bg-gray-800">
                  <Textarea
...
export default AdvancedUpdateUserForm;
