...
const UpdateFormWithAccordion: FC = function () {
                ...
                <div className="grid gap-4 md:gap-6 md:grid-cols-2">
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4 xl:grid-cols-4">
                        <div className="relative p-2 bg-gray-100 rounded-lg xl:w-36 xl:h-36 dark:bg-gray-700">
                          <img
                        ...
                        <div className="relative p-2 bg-gray-100 rounded-lg xl:w-36 xl:h-36 dark:bg-gray-700">
                          ...
                          />
                          <button className="absolute text-red-600 dark:text-red-500 hover:text-red-500 dark:hover:text-red-400 bottom-1 left-1">
                            <svg
                              aria-hidden
                              fill="currentColor"
                              viewBox="0 0 20 20"
...
export default UpdateFormWithAccordion;
